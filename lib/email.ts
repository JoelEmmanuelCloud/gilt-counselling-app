...
export async function sendWelcomeEmail(email: string, name: string) {
                ...
                <tr>
                  <td style="padding: 40px 32px;">
                    ...
                    <p style="margin: 0 0 24px; color: #666666; font-size: 16px; line-height: 1.5; text-align: center;">
                      Dear ${name}, thank you for joining us. Your account has been successfully created and verified.
                    </p>
                    ...
                    <ul style="margin: 0 0 32px; padding-left: 24px; color: #666666; font-size: 15px; line-height: 1.8;">
                      <li>Mental Health Counselling</li>
                      <li>Educational Consulting</li>
                      <li>School Counselling</li>
                      <li>Academic & Career Guidance</li>
                      <li>Youth Counselling</li>
                      <li>Parenting & Special Needs Support</li>
                    </ul>
                    ...
                    <p style="margin: 0; color: #666666; font-size: 14px; line-height: 1.5; text-align: center;">
                      Ready to book your first session? Visit your dashboard to schedule an appointment.
                    </p>
                  </td>
                </tr>
                <tr>
  ...
  return sendEmail({
    ...
    html,
    text: `Welcome ${name}! Thank you for joining Gilt Counselling Consult. Your account has been successfully created. Visit your dashboard at ${dashboardUrl} to book your first session.`,
  });
}

// Counselor Welcome Email
export async function sendCounselorWelcomeEmail(email: string, name: string, tempPassword: string) {
                  ...
                  <td style="padding: 40px 32px;">
                    ...
                    <div style="background-color: #f8f9fa; border: 1px solid #e5e5e5; border-radius: 8px; padding: 24px; margin-bottom: 32px;">
                      <table width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td style="padding: 8px 0;">
                            <p style="margin: 0 0 4px; color: #999999; font-size: 13px; font-weight: 600;">Temporary Password</p>
                            <p style="margin: 0; color: #1a1a1a; font-size: 16px; font-family: monospace;">${tempPassword}</p>
                          </td>
                        </tr>
                      </table>
                    </div>
  ...
  return sendEmail({
    ...
    html,
    text: `Welcome ${name}! Your counselor account has been created. Email: ${email}, Temporary Password: ${tempPassword}. Please sign in at ${loginUrl} and change your password.`,
  });
}
