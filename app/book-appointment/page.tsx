        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-6 md:p-8 mt-6 sm:mt-8 md:mt-10">
          ...
          <div className="mb-8">
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 w-full bg-[#25D366] hover:bg-[#1ebe5d] text-white font-bold text-base sm:text-lg py-4 sm:py-5 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 hover:scale-[1.02]"
            >
