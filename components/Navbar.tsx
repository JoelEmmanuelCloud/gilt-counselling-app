            ...
            <div className="border-t border-light-grey pt-3 mt-3">
              {user ? (
                ...
                <Link
                  href="/book-appointment"
                  onClick={() => setMobileMenuOpen(false)}
                  className="block bg-soft-terracotta text-gray-900 px-5 py-2 rounded hover:bg-soft-terracotta/90 transition-colors duration-300 font-semibold text-center mt-2 uppercase text-sm"
                >
                  Book Session
                </Link>
              )}
