  ...
  return (
    ...
    >
      ...
      <div className="relative w-14 h-14">
        ...
        <span className="absolute inset-0 rounded-full bg-[#25D366] animate-pulse-ring [animation-delay:0.8s]" />
        
        <div className="relative w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 z-10">
